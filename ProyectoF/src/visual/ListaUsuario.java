...
public class ListaUsuario extends JDialog {
	...
	public ListaUsuario() {
		...
		contentPanel.setLayout(null);
		{
			...
			String columns[] = {"Nombre","Direccion","Telefono","Login","Password","Puesto"};
...
private void CargarTable() {
	...
	for (Usuario f : Controladora.getInstance().getMisUsuarios()) {
		fila[0]=f.getNombre();
		fila[1]=f.getDireccion();
		fila[2]=f.getTelefono();
		fila[3]=f.getLogin();
		fila[4]=f.getPassword();
		fila[5]=f.getUsername();
...
public  void buscarTable(String codigo) {
	...
	for (Usuario f : Controladora.getInstance().getMisUsuarios()) {
		...
		if(f.getNombre().equalsIgnoreCase(codigo)) {
